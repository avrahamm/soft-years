...
final class Version20190911141320 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, year_id INT NOT NULL, title VARCHAR(64) NOT NULL, value INT NOT NULL, maximum_value INT NOT NULL, INDEX IDX_64C19C140C1FEA7 (year_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
